...
//饼状图		
        var option_ydzb = {
                ...
                series: [{
                    ...
                    radius : ['0', '153px'],  //饼图的半径,第一项是内半径,第二项是外半径,内半径为0就是真的饼,不是环形
                    startAngle : 90, //旋转角度
                    clockWise : false,
                    itemStyle : {  //图形样式normal:{
                        normal : { //normal 是图形在默认状态下的样式；emphasis 是图形在高亮状态下的样式，比如在鼠标悬浮或者图例联动高亮时。
                        	color : function(params){
                                var colors1 = ['#ff7f7f','#f5efef','#ccffff','#ccccff','#3D3D3D'];
                        		var colors2 = ['#ffaa80','#feada6','#66cccc','#99ccff','#585858'];
...
data: ['组织方式评分 (成熟度 团队合作 架构 成员比)      单位:分']             
}], 
